...
import org.unibl.etf.pisio.trellofa.security.AuthorizationFilter;
import org.unibl.etf.pisio.trellofa.security.models.AuthorizationRules;
import org.unibl.etf.pisio.trellofa.security.models.Rule;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  private HttpSecurity createAuthorizationRules(HttpSecurity http) throws Exception {
      ...
      //  OVDJE OVO ZABRANJUJE I PUSTA SVE return interceptor.anyRequest().denyAll().and();
